...
```html
	...
	<body>
		<div class="sizePosition" style="margin-left:150px;">
			<button class="btn btn-lg btn-detail" data-toggle="popover1" data-container="body"
		...
		<div class="sizePosition">
			<button class="btn btn-lg btn-detail" data-toggle="popover2" data-container="body"
			data-placement="left" data-content="左侧弹出。">左弹出/隐藏</button>
